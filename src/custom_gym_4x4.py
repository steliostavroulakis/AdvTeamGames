...
class SimpleEnv(Env):
    ...
    def __init__(self):
        ...
        self.target3_x = 0
        self.target3_y = self.grid_size-1
    ...
    def render(self, iter):
        ...
        colorstate[self.target3_x][self.target3_y] = (55, 255, 55)
    ...
    def team_wins(self):
        ...
        for team_agent in range(self.num_agents):
            ...
            if coords[x] == self.target2_x and coords[y] == self.target2_y:
                target2_flag = True
            if coords[x] == self.target3_x and coords[y] == self.target3_y:
                target3_flag = True

            
        if target1_flag == True and target2_flag == True and target3_flag == True:
            return True
        else:
            return False
